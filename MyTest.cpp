...
//	Photo PhotoA1Test2("D:\\AlbumFirst\\phototest2.jpg", Date(2015, 10, 23), Time(23, 16), std::make_unique <Person>("Alina", Person::Gender::Fermale), "Отдых 2015");
	...
	Photo PhotoA1Test8("D:\\AlbumFirst\\phototest4.jpg", Date(2014, 7, 05), Time(18, 15), std::make_unique <Person>("Stas", Person::Gender::Fermale), Place("Ploshad", "Kiev", "Ukrain"), "Отдых 2014");
...
//	TestAlbum4.addPhoto(PhotoA4Test10);
	...
	temp.addPhoto(PhotoA4Test1);
	//	TestAlbum4.addPhoto(PhotoA4Test2);
	temp.addPhoto(PhotoA4Test3);
	temp.addPhoto(PhotoA4Test4);
	temp.addPhoto(PhotoA4Test5);
	//	TestAlbum4.addPhoto(PhotoA4Test6);
	temp.addPhoto(PhotoA4Test7);
	temp.addPhoto(PhotoA4Test8);
	temp.addPhoto(PhotoA4Test9);

	temp.addPhoto(PhotoA1Test1);
	//TestAlbum1.addPhoto(PhotoA1Test2);
	temp.addPhoto(PhotoA1Test3);
	temp.addPhoto(PhotoA1Test4);
	temp.addPhoto(PhotoA1Test5);
	//TestAlbum1.addPhoto(PhotoA1Test6);
	temp.addPhoto(PhotoA1Test7);
	temp.addPhoto(PhotoA1Test8);
	temp.addPhoto(PhotoA1Test9);
	temp.addPhoto(PhotoA1Test10);

	temp.addPhoto(PhotoA2Test1);
	//TestAlbum2.addPhoto(PhotoA2Test2);
	temp.addPhoto(PhotoA2Test3);
	temp.addPhoto(PhotoA2Test4);
	temp.addPhoto(PhotoA2Test5);
	//	TestAlbum2.addPhoto(PhotoA2Test6);
	temp.addPhoto(PhotoA2Test7);
	temp.addPhoto(PhotoA2Test8);
	temp.addPhoto(PhotoA2Test9);


	temp.addPhoto(PhotoA3Test1);
	//	TestAlbum3.addPhoto(PhotoA3Test2);
	temp.addPhoto(PhotoA3Test3);
	temp.addPhoto(PhotoA3Test4);
	temp.addPhoto(PhotoA3Test5);
	//	TestAlbum3.addPhoto(PhotoA3Test6);
	temp.addPhoto(PhotoA3Test7);
	temp.addPhoto(PhotoA3Test8);
	temp.addPhoto(PhotoA3Test9);
	//	TestAlbum3.addPhoto(PhotoA3Test10);
	//	TestAlbum2.addPhoto(PhotoA2Test10);
