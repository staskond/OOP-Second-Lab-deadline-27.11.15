...
//Photo Test2("D:\\ ", Date(1995, 10, 10), Time(13, 13), std::make_unique <Person>("naklme", Person::Gender::Male), "i1m ");
	...
	testAlbum.addPhoto(std::make_unique< Photo >("D:\\ ", Date(1997, 10, 10), Time(13, 13), Place("AAA", "BBB", "CCC"), "ß ג למסךגו"));
...
//	}*/
	...
	Photo PhotoA1Test3("D:\\AlbumFirst\\phototest3.jpg", Date(2015, 10, 11), Time(21, 9), std::make_unique <Person>("Julia", Person::Gender::Fermale), Place("Kreml", "Moscow", "Russia"), "־עהûץ 2015");
	Photo PhotoA1Test4("D:\\AlbumFirst\\phototest4.jpg", Date(2014, 9, 05), Time(23, 07), std::make_unique <Person>("Alina", Person::Gender::Fermale), Place("Ploshad", "Kiev", "Ukrain"), "־עהûץ 2014");
	Photo PhotoA1Test5("D:\\AlbumFirst\\phototest5.jpg", Date(2013, 9, 06), Time(00, 01), std::make_unique <Person>("Alina", Person::Gender::Fermale), Place("Otel", "Kiev", "Ukrain"), "־עהûץ 2013");
	Photo PhotoA1Test6("D:\\AlbumFirst\\phototest6.jpg", Date(2012, 5, 30), Time(20, 00), std::make_unique <Person>("Kiril", Person::Gender::Male), "־עהûץ 2012");
	Photo PhotoA1Test7("D:\\AlbumFirst\\phototest5.jpg", Date(2010, 1, 11), Time(8, 40), std::make_unique <Person>("Stas", Person::Gender::Male), Place("Kurort", "Dombai", "Russia"), "־עהûץ 2010");
	Photo PhotoA1Test8("D:\\AlbumFirst\\phototest4.jpg", Date(2014, 9, 05), Time(18, 15), std::make_unique <Person>("Stas", Person::Gender::Fermale), Place("Ploshad", "Kiev", "Ukrain"), "־עהûץ 2014");
	Photo PhotoA1Test9("D:\\AlbumFirst\\phototest4.jpg", Date(2014, 5, 05), Time(17, 33), std::make_unique <Person>("Julia", Person::Gender::Fermale), Place("Subway", "New-York", "USA"), "־עהûץ 2014");
	Photo PhotoA1Test10("D:\\AlbumFirst\\phototest4.jpg", Date(2015, 11, 23), Time(07, 11), std::make_unique <Person>("Julia", Person::Gender::Fermale), Place("Home", "Moscow", "Russia"), "־עהûץ 2015");
	//"Kristina", "Masha", "Bernard", "Bonifaciy", "Lionel" "Benedict", "Barbara", "Beatrisa", 
	Photo PhotoA2Test1("D:\\AlbumSecond\\phototest1.jpg", Date(2009, 6, 10), Time(14, 07), std::make_unique <Person>("Andrey", Person::Gender::Male), Place("Mountain", "Dombai", "Russia"), "־עהûץ 2015");
	Photo PhotoA2Test2("D:\\AlbumSecond\\phototest2.jpg", Date(2011, 10, 23), Time(23, 16), "־עהûץ 2015");
	Photo PhotoA2Test3("D:\\AlbumSecond\\phototest3.jpg", Date(2014, 10, 11), Time(21, 9), Place("Kreml", "Moscow", "Russia"), "־עהûץ 2015");
	Photo PhotoA2Test4("D:\\AlbumSecond\\phototest4.jpg", Date(2014, 9, 05), Time(23, 07), std::make_unique <Person>("Kristina", Person::Gender::Fermale), Place("Ploshad", "Kharkiv", "Ukrain"), "־עהûץ 2014");
	Photo PhotoA2Test5("D:\\AlbumSecond\\phototest5.jpg", Date(2008, 9, 06), Time(00, 01), std::make_unique <Person>("Alina", Person::Gender::Fermale), Place("Subway", "New-York", "USA"), "־עהûץ 2013");
	Photo PhotoA2Test6("D:\\AlbumSecond\\phototest6.jpg", Date(2005, 5, 30), Time(20, 00), std::make_unique <Person>("Bonifaciy", Person::Gender::Male), "־עהûץ 2012");
	Photo PhotoA2Test7("D:\\AlbumSecond\\phototest5.jpg", Date(2007, 1, 11), Time(8, 40), std::make_unique <Person>("Stas", Person::Gender::Male), Place("Kurort", "Dombai", "Russia"), "־עהûץ 2010");
	Photo PhotoA2Test8("D:\\AlbumSecond\\phototest4.jpg", Date(2010, 9, 05), Time(18, 15), std::make_unique <Person>("Barbara", Person::Gender::Fermale), Place("Ploshad", "Kiev", "Ukrain"), "־עהûץ 2014");
	Photo PhotoA2Test9("D:\\AlbumSecond\\phototest4.jpg", Date(2014, 5, 05), Time(17, 33), std::make_unique <Person>("Beatrisa", Person::Gender::Fermale), Place("Subway", "New-York", "USA"), "־עהûץ 2014");
	Photo PhotoA2Test10("D:\\AlbumSecond\\phototest4.jpg", Date(2015, 10, 23), Time(07, 11), std::make_unique <Person>("Bernard", Person::Gender::Male), "־עהûץ 2015");

	Photo PhotoA3Test1("D:\\AlbumThird\\phototest1.jpg", Date(2009, 6, 10), Time(14, 07), Place("Mountain", "Dombai", "Russia"), "־עהûץ 2015");
	Photo PhotoA3Test2("D:\\AlbumThird\\phototest2.jpg", Date(2011, 10, 24), Time(23, 16), "־עהûץ 2015");
	Photo PhotoA3Test3("D:\\AlbumThird\\phototest3.jpg", Date(2014, 10, 11), Time(15, 10), Place("Kreml", "Sankt-Peterburg", "Russia"), "־עהûץ 2015");
	Photo PhotoA3Test4("D:\\AlbumThird\\phototest4.jpg", Date(2014, 9, 11), Time(23, 07), std::make_unique <Person>("Kristina", Person::Gender::Fermale), Place("Ploshad", "Kharkiv", "Ukrain"), "־עהûץ 2014");
	Photo PhotoA3Test5("D:\\AlbumThird\\phototest5.jpg", Date(2008, 9, 06), Time(00, 01), std::make_unique <Person>("Alina", Person::Gender::Fermale), Place("Subway", "New-York", "USA"), "־עהûץ 2013");
	Photo PhotoA3Test6("D:\\AlbumThird\\phototest6.jpg", Date(2005, 9, 30), Time(20, 01), std::make_unique <Person>("Bonifaciy", Person::Gender::Male), "־עהûץ 2012");
	Photo PhotoA3Test7("D:\\AlbumThird\\phototest5.jpg", Date(2007, 1, 12), Time(8, 45), std::make_unique <Person>("Stas", Person::Gender::Male), Place("Kurort", "Alshuk", "Russia"), "־עהûץ 2010");
	Photo PhotoA3Test8("D:\\AlbumThird\\phototest4.jpg", Date(2010, 9, 16), Time(15, 16), std::make_unique <Person>("Barbara", Person::Gender::Fermale), Place("Ploshad", "Kharkiv", "Ukrain"), "־עהûץ 2014");
	Photo PhotoA3Test9("D:\\AlbumThird\\phototest4.jpg", Date(2014, 5, 15), Time(19, 33), std::make_unique <Person>("Beatrisa", Person::Gender::Fermale), Place("Subway", "New-York", "USA"), "־עהûץ 2014");
	Photo PhotoA3Test10("D:\\AlbumThird\\phototest4.jpg", Date(2015, 5, 23), Time(11, 11), std::make_unique <Person>("Bernard", Person::Gender::Male), "־עהûץ 2015");


	Photo PhotoA4Test1("D:\\AlbumFourth\\phototest1.jpg", Date(2009, 6, 10), Time(14, 07), Place("Mountain", "Jorjia", "Russia"), "־עהûץ 2015");
	Photo PhotoA4Test2("D:\\AlbumFourth\\phototest2.jpg", Date(2011, 10, 24), Time(23, 16), "־עהûץ 2015");
	Photo PhotoA4Test3("D:\\AlbumFourth\\phototest3.jpg", Date(2014, 10, 11), Time(15, 10), Place("Kreml", "Sankt-Peterburg", "Russia"), "־עהûץ 2015");
	Photo PhotoA4Test4("D:\\AlbumFourth\\phototest4.jpg", Date(2014, 9, 11), Time(23, 07), Place("Ploshad", "Kharkiv", "Ukrain"), "־עהûץ 2014");
	Photo PhotoA4Test5("D:\\AlbumFourth\\phototest5.jpg", Date(2008, 9, 06), Time(00, 01), Place("Subway", "New-York", "USA"), "־עהûץ 2013");
	Photo PhotoA4Test6("D:\\AlbumFourth\\phototest6.jpg", Date(2005, 9, 30), Time(20, 01),  "־עהûץ 2012");
	Photo PhotoA4Test7("D:\\AlbumFourth\\phototest5.jpg", Date(2007, 1, 12), Time(8, 45),  Place("Kurort", "HelpME", "Russia"), "־עהûץ 2010");
	Photo PhotoA4Test8("D:\\AlbumFourth\\phototest4.jpg", Date(2010, 9, 16), Time(15, 16),  Place("Ploshad", "Kharkiv", "Ukrain"), "־עהûץ 2014");
	Photo PhotoA4Test9("D:\\AlbumFourth\\phototest4.jpg", Date(2014, 5, 15), Time(19, 33),  Place("Subway", "Vanglavud", "USA"), "־עהûץ 2014");
	Photo PhotoA4Test10("D:\\AlbumFourth\\phototest4.jpg", Date(2015, 5, 23), Time(11, 11), "־עהûץ 2015");
	//"Kristina", "Masha", "Bernard", "Bonifaciy", "Lionel" "Benedict", "Barbara", "Beatrisa", 
